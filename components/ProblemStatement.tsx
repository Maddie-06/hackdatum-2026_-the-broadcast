          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-6">
                <span className="bg-navy text-white px-3 py-1 font-mono text-[10px] font-bold uppercase tracking-widest">Signal. Scope. Challenge.</span>
              ...
              <h2 className="text-6xl md:text-8xl font-black tracking-tighter uppercase leading-[0.85] mb-8">
                Welcome to the<br/>
                <span className="text-signalRed">Problem Statements</span>
              </h2>

              <p className="text-xl md:text-2xl font-medium leading-relaxed opacity-90 mb-12">
                HackDATUM goes beyond challenges; it’s a focused broadcast of problem statements and domains. Lets dive deep into the technical challenges, we tune frequencies to explore, solve, innovate, and shape tomorrow.              </p>
